...
def upload_and_wait(path, status_box):
    status_box.write("⬆️ Uploading video to Gemini...")
...
"""
                    ...
                    tick("⬇️ Downloading video")
                    subprocess.run(
                        ["yt-dlp", "-f", "mp4", "-o", VIDEO_FILE, youtube_url],
